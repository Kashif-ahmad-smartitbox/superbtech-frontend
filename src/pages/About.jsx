...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-primary-50/20 to-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-secondary-800">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold bg-gradient-to-r from-primary-500 to-secondary-500 bg-clip-text text-transparent mb-4 leading-tight">
              Superb Technologies
            ...
            <p className="text-lg sm:text-xl text-white/80 mb-6 leading-relaxed max-w-3xl mx-auto px-4">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 justify-center">
              <a
                ...
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-transparent border-2 border-white/30 text-white font-bold rounded-lg hover:bg-white/10 hover:border-white/50 transition-all duration-300 hover:-translate-y-1 flex items-center gap-2 text-sm sm:text-base"
              >
      ...
      {/* Stats Grid */}
      <div className="container mx-auto px-4 sm:px-6 -mt-6 sm:-mt-10 lg:-mt-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-white rounded-xl sm:rounded-2xl border border-primary-100 p-3 sm:p-4 hover:shadow-2xl hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500"
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center flex-shrink-0 mx-auto sm:mx-0">
                  <div className="text-lg sm:text-xl text-white">
                    {stat.icon}
                  </div>
                </div>
                <div className="text-center sm:text-left">
                  <div className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-primary-700 to-secondary-600 bg-clip-text text-transparent">
                    {stat.number}
                  </div>
            ...
            <div className="relative rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl">
              <div className="aspect-[4/3] bg-gradient-to-br from-primary-400 to-secondary-500 flex items-center justify-center">
                <div className="text-center p-6">
                  <FaUniversity className="w-16 h-16 text-white/80 mx-auto mb-4" />
      ...
      {/* Leadership */}
      <div className="bg-gradient-to-b from-primary-50/30 via-white to-primary-50/20 py-8 sm:py-12 lg:py-16">
        <div className="container">
          <div className="max-w-7xl">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl border border-primary-100 p-4 sm:p-6 lg:p-8">
              <div className="flex flex-col lg:flex-row gap-6 items-center">
                <div className="flex-shrink-0">
                  <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <div className="text-primary-600 text-base sm:text-lg font-semibold mb-3">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {infrastructure.map((item, index) => (
            <div
              key={index}
              className="group bg-white rounded-xl sm:rounded-2xl shadow-lg border border-primary-100 p-4 hover:shadow-2xl hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-500"
            >
              <div
                className={`w-10 h-10 rounded-lg bg-gradient-to-br ${item.color} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}
              >
        ...
        <div className="mt-8 sm:mt-12 grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Product Categories */}
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-primary-100 p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {productCategories.map((category, index) => (
                ...
                >
                  <FiCheckCircle className="text-green-500 w-3 h-3 flex-shrink-0" />
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-primary-100 p-4 sm:p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {exportCountries.map((country, index) => (
                <span
                  key={index}
                  className="inline-flex items-center gap-1 px-2.5 py-1 bg-secondary-50 text-secondary-700 rounded-full text-xs sm:text-sm"
                >
      ...
      <div className="bg-gradient-to-b from-white to-primary-50/20 py-8 sm:py-12 lg:py-16">
                ...
                <div className="animate-fade-in">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    {[
                      ...
                      <div
                        key={index}
                        className="p-3 bg-primary-50/30 rounded-lg"
                      >
                        <div className="text-xs text-primary-700 font-medium mb-0.5">
                          {item.label}
                        </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      {shipmentModes.map((mode, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-2 p-2.5 bg-primary-50 rounded-lg"
                        >
                          {mode.icon}
      ...
      {/* Contact & Location */}
      <div className="bg-gradient-to-br from-primary-900 via-primary-800 to-secondary-900 py-8 sm:py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
              {/* Address Card */}
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 p-4 sm:p-6 shadow-xl">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <FiMapPin className="w-4 h-4 text-primary-200 mt-0.5 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-center gap-3 p-2 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                    ...
                    <div>
                      <a
                        href="tel:+919829132777"
                        className="text-white hover:text-secondary-300 font-medium transition-colors text-base"
                      >
                        +91 90348 15524
                      </a>
                      <p className="text-primary-200 text-xs mt-0.5">
                  ...
                  <div className="flex items-center gap-3 p-2 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                    ...
                    <div>
                      <a
                        ...
                        className="text-white hover:text-secondary-300 font-medium transition-colors text-sm"
                      >
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/20 p-4 sm:p-6 shadow-xl">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-secondary-500 to-primary-500 flex items-center justify-center shadow-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors group">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-primary-500/20 flex items-center justify-center group-hover:bg-primary-500/30 transition-colors">
                        <FiPackage className="w-4 h-4 text-primary-300" />
                      </div>
                      <span className="text-primary-100 text-sm">Factory Area</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors group">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-secondary-500/20 flex items-center justify-center group-hover:bg-secondary-500/30 transition-colors">
                        <FiHome className="w-4 h-4 text-secondary-300" />
                      </div>
                      <span className="text-primary-100 text-sm">Infrastructure</span>
                    </div>
                    <span className="text-white font-bold text-base">
                      Permanent Building
                    </span>
                  ...
                  <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors group">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-primary-100 text-sm">Team Size</span>
                    </div>
                    <span className="text-white font-bold text-base">
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <Link
                      to="/products"
                      className="inline-flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-bold rounded-lg hover:from-primary-600 hover:to-secondary-600 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 shadow-lg group text-sm"
                    >
                    ...
                    <p className="text-primary-200 text-center text-xs mt-2">
            ...
            <div className="mt-8 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 rounded-full border border-white/20">
                <FiClock className="w-3 h-3 text-primary-200" />
