    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-primary-50 py-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="bg-white rounded-2xl border border-primary-100 overflow-hidden mb-8">
          {/* Card Header */}
          <div className="bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 text-white p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              ...
              <div className="bg-gradient-to-r from-secondary-50 to-white p-4 rounded-xl border border-secondary-200">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-bold text-secondary-800">Coordinates</h3>
                </div>
                <p className="text-sm text-gray-700">
            ...
            <div className="flex flex-wrap gap-3 mt-6 justify-center">
              ...
              >
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm0 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm.03 4c-3.87 0-7 3.13-7 7 0 1.45.44 2.8 1.2 3.92L12 22l5.77-5.08c.76-1.12 1.2-2.47 1.2-3.92 0-3.87-3.13-7-7-7zm0 2c2.76 0 5 2.24 5 5s-2.24 5-5 5-5-2.24-5-5 2.24-5 5-5z" />
                </svg>
                Waze Directions
              </a>
              <button
